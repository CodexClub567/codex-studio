	...
	window.codexSlide = {
		...
		start: function( element ) {
			...
			var options = {
				...
				i18n: {
					...
					prev: prevLabel,
					next: nextLabel,
					slideLabel: '%s ' + codexSlideConfig.of + ' %s',
				},
				breakpoints: {
					543: {
						perPage: ss,
		...
		init: function() {
			if ( typeof Splide == 'function' ) {
				...
				var initLoadDelay = setInterval( function(){ if ( typeof Splide == 'function' ) { window.codexSlide.initAll(); clearInterval(initLoadDelay); } }, 200 );
			}
		}
	}
