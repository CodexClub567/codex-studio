...
class ResponsiveControl extends Component {
	...
	render() {
		...
		deviceMap = {
			'desktop': {
				'tooltip': __( 'Desktop', 'codex' ),
				'icon': <Icon icon={ Icons.desktop }/>
			},
			'tablet': {
				'tooltip': __( 'Tablet', 'codex' ),
				'icon': <Icon icon={ Icons.tablet }/>
			},
			'mobile': {
				'tooltip': __( 'Mobile', 'codex' ),
	...
	linkResponsiveButtons() {
		let self = this;
		document.addEventListener( 'codexChangedRepsonsivePreview', function(e) {
