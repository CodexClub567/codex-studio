...
export const codexColorPicker = ({ rgb, hex, hsv, hsl, onChange, renderers }) => {
  const styles = {
	picker: {
		width: 300,
		position: 'relative',
  ...
  return (
    <div style={ styles.picker } className={ 'codex-picker' }>
...
export default CustomPicker(codexColorPicker)