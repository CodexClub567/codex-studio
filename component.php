<?php
/**
 * codex\Icons\Component class
 *
 * @package codex
 */

namespace codex\Icons;
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function get_icon( $icon = 'search', $icon_title = '', $base = true, $aria = false ) {
		$display_title = apply_filters( 'codex_svg_icons_have_title', true );
		$output = '<span class="codex-svg-iconset' . ( $base ? ' svg-baseline' : '' ) . '">';
		switch ( $icon ) {
			case 'moon':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-moon-svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>
				</svg>';
				break;
			case 'moonAlt':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-moon-alt-svg" fill="currentColor" version="1.1" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'sun':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-sun-svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'sunAlt':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-sun-alt-svg" fill="currentColor" version="1.1" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'sunrise':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-sunrise-svg" fill="currentColor" version="1.1" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Light Mode', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'sunset':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-sunset-svg" fill="currentColor" version="1.1" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dark Mode', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'settings':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-settings-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Settings', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'home':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-home-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Home', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M9.984 20.016h-4.969v-8.016h-3l9.984-9 9.984 9h-3v8.016h-4.969v-6h-4.031v6z"></path>
				</svg>';
				break;
			case 'search':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-search-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Search', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'search2':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-search2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Search', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'zoom':
				$output .= '<svg class="codex-svg-icon codex-zoom-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Zoom In', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M18 13c0-3.859-3.141-7-7-7s-7 3.141-7 7 3.141 7 7 7 7-3.141 7-7zM26 26c0 1.094-0.906 2-2 2-0.531 0-1.047-0.219-1.406-0.594l-5.359-5.344c-1.828 1.266-4.016 1.937-6.234 1.937-6.078 0-11-4.922-11-11s4.922-11 11-11 11 4.922 11 11c0 2.219-0.672 4.406-1.937 6.234l5.359 5.359c0.359 0.359 0.578 0.875 0.578 1.406z"></path>
				</svg>';
				break;
			case 'bag':
				$output .= '<svg class="codex-svg-icon codex-bag-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bag', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'facebook':
				$output .= '<svg class="codex-svg-icon codex-facebook-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'facebookAlt':
				$output .= '<svg class="codex-svg-icon codex-facebook-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'facebookAlt2':
				$output .= '<svg class="codex-svg-icon codex-facebook-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="28" viewBox="0 0 16 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'twitter':
				$output .= '<svg class="codex-svg-icon codex-twitter-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Twitter', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'twitterAlt':
				$output .= '<svg class="codex-svg-icon codex-twitter-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Twitter', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'twitterAlt2':
				$output .= '<svg class="codex-svg-icon codex-twitter-x-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="23" height="24" viewBox="0 0 23 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'X', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'tiktok':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-tiktok-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'TikTok', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'discord':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-discord-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Discord', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'instagram':
				$output .= '<svg class="codex-svg-icon codex-instagram-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Instagram', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'instagramAlt':
				$output .= '<svg class="codex-svg-icon codex-instagram-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Instagram', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'threads':
				$output .= '<svg class="codex-svg-icon codex-threads-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 448 512">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Threads', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'vimeo':
				$output .= '<svg class="codex-svg-icon codex-vimeo-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Vimeo', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'youtube':
				$output .= '<svg class="codex-svg-icon codex-youtube-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'YouTube', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'youtubeAlt':
				$output .= '<svg class="codex-svg-icon codex-youtube-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'YouTube', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'github':
				$output .= '<svg class="codex-svg-icon codex-github-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Github', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'githubAlt':
				$output .= '<svg class="codex-svg-icon codex-github-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Github', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'rss':
				$output .= '<svg class="codex-svg-icon codex-rss-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'rssAlt':
				$output .= '<svg class="codex-svg-icon codex-rss-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'facebook_group':
				$output .= '<svg class="codex-svg-icon codex-facebook-group-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="30" height="28" viewBox="0 0 30 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Facebook Group', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'dribbble':
				$output .= '<svg class="codex-svg-icon codex-dribbble-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Dribbble', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'xing':
				$output .= '<svg class="codex-svg-icon codex-xing-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="22" height="28" viewBox="0 0 22 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Xing', 'codex' ) ) . '</title>';
				}
			...
			case 'wordpress': // phpcs:ignore WordPress.WP.CapitalPDangit.Misspelled
				$output .= '<svg class="codex-svg-icon codex-wordpress-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WordPress', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'whatsapp':
				$output .= '<svg class="codex-svg-icon codex-whatsapp-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'WhatsApp', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'vk':
				$output .= '<svg class="codex-svg-icon codex-vk-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="31" height="28" viewBox="0 0 31 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'VK', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'tumblr':
				$output .= '<svg class="codex-svg-icon codex-tumblr-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="17" height="28" viewBox="0 0 17 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Tumblr', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M14.75 20.766l1.25 3.703c-0.469 0.703-2.594 1.5-4.5 1.531-5.672 0.094-7.812-4.031-7.812-6.937v-8.5h-2.625v-3.359c3.938-1.422 4.891-4.984 5.109-7.016 0.016-0.125 0.125-0.187 0.187-0.187h3.813v6.625h5.203v3.937h-5.219v8.094c0 1.094 0.406 2.609 2.5 2.562 0.688-0.016 1.609-0.219 2.094-0.453z"></path>
				</svg>';
				break;
			case 'reddit':
				$output .= '<svg class="codex-svg-icon codex-reddit-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Reddit', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'redditAlt':
				$output .= '<svg class="codex-svg-icon codex-reddit-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Reddit', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'patreon':
				$output .= '<svg class="codex-svg-icon codex-patreon-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Patreon', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'medium':
				$output .= '<svg class="codex-svg-icon codex-medium-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Medium', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'behance':
				$output .= '<svg class="codex-svg-icon codex-behance-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="28" viewBox="0 0 32 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Behance', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'anchor':
				$output .= '<svg class="codex-svg-icon codex-anchor-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Anchor', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'soundcloud':
				$output .= '<svg class="codex-svg-icon codex-soundcloud-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'SoundCloud', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'soundcloudAlt':
				$output .= '<svg class="codex-svg-icon codex-soundcloud-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'SoundCloud', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'email':
				$output .= '<svg class="codex-svg-icon codex-email-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'emailAlt':
				$output .= '<svg class="codex-svg-icon codex-email-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'emailAlt2':
				$output .= '<svg class="codex-svg-icon codex-email-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Email', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'phone':
				$output .= '<svg class="codex-svg-icon codex-phone-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="12" height="28" viewBox="0 0 12 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M7.25 22c0-0.688-0.562-1.25-1.25-1.25s-1.25 0.562-1.25 1.25 0.562 1.25 1.25 1.25 1.25-0.562 1.25-1.25zM10.5 19.5v-11c0-0.266-0.234-0.5-0.5-0.5h-8c-0.266 0-0.5 0.234-0.5 0.5v11c0 0.266 0.234 0.5 0.5 0.5h8c0.266 0 0.5-0.234 0.5-0.5zM7.5 6.25c0-0.141-0.109-0.25-0.25-0.25h-2.5c-0.141 0-0.25 0.109-0.25 0.25s0.109 0.25 0.25 0.25h2.5c0.141 0 0.25-0.109 0.25-0.25zM12 6v16c0 1.094-0.906 2-2 2h-8c-1.094 0-2-0.906-2-2v-16c0-1.094 0.906-2 2-2h8c1.094 0 2 0.906 2 2z"></path>
				</svg>';
				break;
			case 'phoneAlt':
				$output .= '<svg class="codex-svg-icon codex-phone-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'phoneAlt2':
				$output .= '<svg class="codex-svg-icon codex-phone-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Phone', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'google_reviews':
				$output .= '<svg class="codex-svg-icon codex-google-reviews-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Google Reviews', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'telegram':
				$output .= '<svg class="codex-svg-icon codex-telegram-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Telegram', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'telegramAlt':
				$output .= '<svg class="codex-svg-icon codex-telegram-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Telegram', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'trip_advisor':
				$output .= '<svg class="codex-svg-icon codex-trip-advisor-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="36" height="28" viewBox="0 0 36 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Trip Advisor', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'yelp':
				$output .= '<svg class="codex-svg-icon codex-yelp-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Yelp', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'user':
				$output .= '<svg class="codex-svg-icon codex-user-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'User', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'comments':
				$output .= '<svg class="codex-svg-icon codex-comments-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Comments', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'commentsAlt':
				$output .= '<svg class="codex-svg-icon codex-comments-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Comments', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'folder':
				$output .= '<svg class="codex-svg-icon codex-comments-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Categories', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'grid':
				$output .= '<svg class="codex-svg-icon codex-grid-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Grid', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'gridlarge':
				$output .= '<svg class="codex-svg-icon codex-gridlarge-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Grid', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'list':
				$output .= '<svg class="codex-svg-icon codex-list-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'List', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M1 3h14v3h-14zM1 7h14v3h-14zM1 11h14v3h-14z"></path>
				</svg>';
				break;
			case 'account':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-account-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'account2':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-account2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'account3':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-account3-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Account', 'codex' ) ) . '</title>';
				}
				...
				break;	
			case 'feed':
				$output .= '<svg class="codex-svg-icon codex-feed-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="22" height="28" viewBox="0 0 22 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'RSS', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'pinterest':
				$output .= '<svg class="codex-svg-icon codex-pinterest-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Pinterest', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'pinterestAlt':
				$output .= '<svg class="codex-svg-icon codex-pinterest-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Pinterest', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'mobile':
				$output .= '<svg class="codex-svg-icon codex-mobile-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="12" height="28" viewBox="0 0 12 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Mobile', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M7.25 22c0-0.688-0.562-1.25-1.25-1.25s-1.25 0.562-1.25 1.25 0.562 1.25 1.25 1.25 1.25-0.562 1.25-1.25zM10.5 19.5v-11c0-0.266-0.234-0.5-0.5-0.5h-8c-0.266 0-0.5 0.234-0.5 0.5v11c0 0.266 0.234 0.5 0.5 0.5h8c0.266 0 0.5-0.234 0.5-0.5zM7.5 6.25c0-0.141-0.109-0.25-0.25-0.25h-2.5c-0.141 0-0.25 0.109-0.25 0.25s0.109 0.25 0.25 0.25h2.5c0.141 0 0.25-0.109 0.25-0.25zM12 6v16c0 1.094-0.906 2-2 2h-8c-1.094 0-2-0.906-2-2v-16c0-1.094 0.906-2 2-2h8c1.094 0 2 0.906 2 2z"></path>
				</svg>';
				break;
			case 'hours':
				$output .= '<svg class="codex-svg-icon codex-hours-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'hoursAlt':
				$output .= '<svg class="codex-svg-icon codex-hours-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'hoursAlt2':
				$output .= '<svg class="codex-svg-icon codex-hours-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Hours', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'location':
				$output .= '<svg class="codex-svg-icon codex-location-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="28" viewBox="0 0 16 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'locationAlt':
				$output .= '<svg class="codex-svg-icon codex-location-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'locationAlt2':
				$output .= '<svg class="codex-svg-icon codex-location-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Location', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'envelop':
				$output .= '<svg class="codex-svg-icon codex-envelop-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Envelop', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'linkedin':
				$output .= '<svg class="codex-svg-icon codex-linkedin-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Linkedin', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'linkedinAlt':
				$output .= '<svg class="codex-svg-icon codex-linkedin-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Linkedin', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'goodreads':
				$output .= '<svg class="codex-svg-icon codex-goodreads-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Goodreads', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'amazon':
				$output .= '<svg class="codex-svg-icon codex-amazon-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Amazon', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'bookbub':
				$output .= '<svg class="codex-svg-icon codex-bookbub-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'BookBub', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'quotes':
				$output .= '<svg'. ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-quotes-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Quotes', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-left':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-arrow-left-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Previous', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-right':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-arrow-right-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Next', 'codex' ) ) . '</title>';
				}
			...
			case 'arrow-right-alt':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-arrow-right-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="27" height="28" viewBox="0 0 27 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Continue', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M27 13.953c0 0.141-0.063 0.281-0.156 0.375l-6 5.531c-0.156 0.141-0.359 0.172-0.547 0.094-0.172-0.078-0.297-0.25-0.297-0.453v-3.5h-19.5c-0.281 0-0.5-0.219-0.5-0.5v-3c0-0.281 0.219-0.5 0.5-0.5h19.5v-3.5c0-0.203 0.109-0.375 0.297-0.453s0.391-0.047 0.547 0.078l6 5.469c0.094 0.094 0.156 0.219 0.156 0.359v0z"></path>
				</svg>';
				break;
			case 'arrow-left-alt':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-arrow-left-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="29" height="28" viewBox="0 0 29 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Previous', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-down':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-arrow-down-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Expand', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-up':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-arrow-up-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'arrow-up2':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-arrow-up2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 26 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'chevron-up':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-chevron-up-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'chevron-up2':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-chevron-up2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Arrow Up', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'menu':
				$output .= '<svg' . ( ! $aria ? ' aria-hidden="true"' : '' ) . ' class="codex-svg-icon codex-menu-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'menu2':
				$output .= '<svg class="codex-svg-icon codex-menu2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'menu3':
				$output .= '<svg class="codex-svg-icon codex-menu3-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'listFilter':
				$output .= '<svg class="codex-svg-icon codex-list-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Filter', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'listFilterAlt':
				$output .= '<svg class="codex-svg-icon codex-list-filter-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Filter', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'close':
				$output .= '<svg class="codex-svg-icon codex-close-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'closeAlt':
				$output .= '<svg class="codex-svg-icon codex-close-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'closeAlt2':
				$output .= '<svg class="codex-svg-icon codex-close-alt2-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Toggle Menu Close', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'shopping-bag':
				$output .= '<svg class="codex-svg-icon codex-shopping-bag-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Shopping Cart', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'shopping-cart':
				$output .= '<svg class="codex-svg-icon codex-shopping-cart-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Shopping Cart', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'apple_podcasts':
				$output .= '<svg class="codex-svg-icon codex-apple-podcasts-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Apple Podcasts', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'spotify':
				$output .= '<svg class="codex-svg-icon codex-spotify-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Spotify', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'flickr':
				$output .= '<svg class="codex-svg-icon codex-flicker-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Flicker', 'codex' ) ) . '</title>';
				}
				...
				break;
			case '500px':
				$output .= '<svg class="codex-svg-icon codex-500px-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( '500PX', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'bandcamp':
				$output .= '<svg class="codex-svg-icon codex-bandcamp-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Bandcamp', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M0 18.75l7.437-13.5H24l-7.438 13.5H0z" />
				</svg>';
				break;
			case 'imdb':
				$output .= '<svg class="codex-svg-icon codex-imdb-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="28" viewBox="0 0 24 28">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'IMDB', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'spinner':
				$output .= '<svg class="codex-svg-icon codex-spinner-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Loading', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'check':
				$output .= '<svg class="codex-svg-icon codex-check-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Done', 'codex' ) ) . '</title>';
				}
				$output .= '<path d="M14 2.5l-8.5 8.5-3.5-3.5-1.5 1.5 5 5 10-10z"></path>
				</svg>';
				break;
			case 'checkbox':
				$output .= '<svg class="codex-svg-icon codex-checkbox-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Check Mark', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'checkbox_alt':
				$output .= '<svg class="codex-svg-icon codex-checkbox-alt-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Check Mark', 'codex' ) ) . '</title>';
				}
			...
			case 'shield_check':
				...
				break;
			case 'disc':
				$output .= '<svg class="codex-svg-icon codex-disc-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Disc', 'codex' ) ) . '</title>';
				}
			...
			case 'visa':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Visa Card', 'codex' ) ) . '</title>';
				}
			...
			case 'mastercard':
				$output .= '<svg width="100%" height="100%" viewBox="0 0 750 471" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'MasterCard', 'codex' ) ) . '</title>';
				}
			...
			case 'amex':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'American Express', 'codex' ) ) . '</title>';
				}
			...
			case 'discover':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Discover Card', 'codex' ) ) . '</title>';
				}
			...
			case 'paypal':
				$output .= '<svg width="100%" height="100%" viewBox="0 0 780 501" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">';
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'PayPal', 'codex' ) ) . '</title>';
				}
			...
			case 'applepay':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Apple Pay', 'codex' ) ) . '</title>';
				}
			...
			case 'stripe':
				...
				if ( $display_title ) {
					$output .= '<title>' . ( ! empty( $icon_title ) ? $icon_title : esc_html__( 'Stripe', 'codex' ) ) . '</title>';
				}
				...
				break;
			case 'logoCircle':
				$output .= '<svg class="codex-svg-icon codex-logo-circle-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 512 512" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">';
				$output .= '
				...
				break;
			case 'logoArrow':
				$output .= '<svg class="codex-svg-icon codex-logo-arrow-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 512 422">';
				...
				break;
			case 'logoLine':
				$output .= '<svg class="codex-svg-icon codex-logo-line-svg" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 512 212">';
		...
		$output = apply_filters( 'codex_svg_icon', $output, $icon, $icon_title, $base );
