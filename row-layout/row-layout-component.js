...
class RowLayoutComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			desktop: {
				'column5': {
					'equal': {
						tooltip: __( 'Equal Width Columns', 'codex' ),
						icon: 'fivecol',
					},
				},
				'column4': {
					...
					'left-forty': {
						tooltip: __( 'Left Heavy 40/20/20/20', 'codex' ),
						icon: 'lfourforty',
					},
					'right-forty': {
						tooltip: __( 'Right Heavy 20/20/20/40', 'codex' ),
						icon: 'rfourforty',
					},
				},
				'column3': {
					...
					'left-half': {
						tooltip: __( 'Left Heavy 50/25/25', 'codex' ),
						icon: 'lefthalf',
					},
					'right-half': {
						tooltip: __( 'Right Heavy 25/25/50', 'codex' ),
						icon: 'righthalf',
					},
					'center-half': {
						tooltip: __( 'Center Heavy 25/50/25', 'codex' ),
						icon: 'centerhalf',
					},
					'center-wide': {
						tooltip: __( 'Wide Center 20/60/20', 'codex' ),
						icon: 'widecenter',
					},
				},
				'column2': {
					...
					'left-golden': {
						tooltip: __( 'Left Heavy 66/33', 'codex' ),
						icon: 'twoleftgolden',
					},
					'right-golden': {
						tooltip: __( 'Right Heavy 33/66', 'codex' ),
						icon: 'tworightgolden',
					},
				},
				'column1': {
			...
			mobile: {
				'column5': {
					...
					'row': {
						tooltip: __( 'Collapse to Rows', 'codex' ),
				...
				'column4': {
					...
					'two-grid': {
						tooltip: __( 'Two Column Grid', 'codex' ),
						icon: 'grid',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'codex' ),
				...
				'column3': {
					...
					'first-row': {
						tooltip: __( 'First Row, Next Columns 100 - 50/50', 'codex' ),
						icon: 'firstrow',
					},
					'last-row': {
						tooltip: __( 'Last Row, Previous Columns 50/50 - 100', 'codex' ),
						icon: 'lastrow',
					},
					'row': {
						tooltip: __( 'Collapse to Rows', 'codex' ),
	...
	render() {
		...
		return (
			<div className="codex-control-field codex-radio-icon-control codex-row-layout-control">
											...
											<Tooltip text={ controlMap[ item ].tooltip }>
												...
												>
													...
													{ controlMap[ item ].dashicon && (
														<span className="codex-radio-icon codex-radio-dashicon">
				...
				{ ! this.controlParams.responsive && (
					<Fragment>
						<div className="codex-responsive-control-bar">
	...
	linkColumns() {
		let self = this;
		document.addEventListener( 'codexUpdateFooterColumns', function( e ) {
