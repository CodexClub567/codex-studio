...
$settings = array(
	...
	'course_title' => array(
		...
		'section'      => 'course_layout',
		'priority'     => 3,
		'default'      => codex()->default( 'course_title' ),
	...
	'course_title_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 4,
		'default'      => codex()->default( 'course_title_layout' ),
		'context'      => array(
			array(
	...
	'course_title_inner_layout' => array(
		...
		'section'      => 'course_layout',
		'priority'     => 4,
		'default'      => codex()->default( 'course_title_inner_layout' ),
	...
	'course_title_align' => array(
		...
		'priority'     => 4,
		'default'      => codex()->default( 'course_title_align' ),
		'context'      => array(
			array(
				'setting'    => 'course_title',
				'operator'   => '=',
	...
	'course_title_height' => array(
		...
		'default'      => codex()->default( 'course_title_height' ),
		'input_attrs'  => array(
			'min'     => array(
				'px'  => 10,
				'em'  => 1,
	...
	'course_title_elements' => array(
		...
		'section'      => 'course_layout',
		'priority'     => 6,
		'default'      => codex()->default( 'course_title_elements' ),
	...
	'course_title_breadcrumb_color' => array(
		...
		'default'      => codex()->default( 'course_title_breadcrumb_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'course_title_background' => array(
		...
		'default'      => codex()->default( 'course_title_background' ),
		'context'      => array(
			array(
				'setting'    => 'course_title',
				'operator'   => '=',
	...
	'course_title_featured_image' => array(
		...
		'sanitize'     => 'codex_sanitize_toggle',
		'section'      => 'course_layout_design',
		'default'      => codex()->default( 'course_title_featured_image' ),
	...
	'course_title_overlay_color' => array(
		...
		'default'      => codex()->default( 'course_title_overlay_color' ),
		'live_method'     => array(
			array(
				'type'     => 'css',
	...
	'course_title_border' => array(
		...
		'default'      => codex()->default( 'course_title_border' ),
		'context'      => array(
			array(
				'setting'    => 'course_title',
				'operator'   => '=',
	...
	'course_layout' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => codex()->default( 'course_layout' ),
		'input_attrs'  => array(
			'layout' => array(
				'normal' => array(
	...
	'course_sidebar_id' => array(
		...
		'transport'    => 'refresh',
		'priority'     => 10,
		'default'      => codex()->default( 'course_sidebar_id' ),
		'input_attrs'  => array(
	...
	'course_vertical_padding' => array(
		...
		'priority'     => 10,
		'default'      => codex()->default( 'course_vertical_padding' ),
		'live_method'     => array(
			array(
				'type'     => 'class',
				'selector' => 'body.single-course',
	...
	'course_comments' => array(
		...
		'section'      => 'course_layout',
		'priority'     => 20,
		'default'      => codex()->default( 'course_comments' ),
