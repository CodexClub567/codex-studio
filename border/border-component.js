	...
	render() {
		...
		const responsiveControlLabel = (
			<Fragment>
				...
				{ this.state.currentDevice === 'desktop' && (
					<Tooltip text={ __( 'Reset All Values', 'codex' ) }>
						<Button
							className="reset codex-reset"
							onClick={ () => {
								this.resetValues();
		...
		return (
			<div ref={ this.anchorNodeRef } className="codex-control-field codex-border-control">
				{ this.controlParams.responsive && (
					...
					>
						...
						{ this.controlParams.styles && (
							<div className="codex-units codex-style-options">
