...
class MeasureComponent extends Component {
	...
	render() {
		...
		return (
			<div className="codex-control-field codex-range-control">
				{ this.controlParams.responsive && (
					<ResponsiveControl
					...
					>
						...
						<div className="codex-units codex-locked">
				...
				{ ! this.controlParams.responsive && (
					<Fragment>
						...
						<div className="codex-responsive-controls-content">
							{ this.state.locked && (
								<RangeControl
