...
function CustomColorPickerDropdown( {
	...
	return (
		<CustomDropdown
			contentClassName="components-color-palette__custom-color-dropdown-content codex-pop-color-popover"
			...
			ignoreMarkerPosition !== initialPosition && (
				<GradientColorPickerDropdown
					...
					renderContent={ ( { onClose } ) => (
						<div className="codex-pop-gradient-color-picker">
							<HStack
								...
								{ map( colors, ( { color, slug, name } ) => {
									...
									return (
										<div key={ key } style={ {
											...
											<Button
												className={ `codex-swatch-item ${ isActive ? 'swatch-active' : 'swatch-inactive' }` }
												style={ {
													height: '100%',
													width: '100%',
