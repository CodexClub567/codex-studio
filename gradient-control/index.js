...
const GradientTypePicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<SelectControl
			className="components-custom-gradient-picker__type-picker codex-select-large"
			label={ __( 'Type' ) }
			labelPosition="top"
...
const GradientPositionPicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<div className={ `components-base-control codex-gradient-position-control` }>
				<Flex
					justify="space-between"
					className={ 'codex-gradient-position_header' }
				>
					<FlexItem>
						<label className="codex-gradient-position__label">{ __( 'Position', 'codex-blocks' ) }</label>
					</FlexItem>
				</Flex>
				{ positionType === 'position-keyword' && (
					<div className={ 'codex-controls-content' }>
						<SelectControl
							className="components-custom-gradient-picker__position-picker"
							// label={ __( 'Position', 'codex-blocks' ) }
							// labelPosition="top"
						...
						/>
						<Button
							className={'codex-control-toggle-advanced only-icon'}
							label={ __( 'Set custom position', 'codex-blocks' ) }
							icon={ settings }
				...
				{ positionType !== 'position-keyword' && (
					<div className={ 'codex-controls-content' }>
						...
						<Button
							className={'codex-control-toggle-advanced only-icon'}
							label={ __( 'Set standard position', 'codex-blocks' ) }
							icon={ settings }
...
const GradientShapePicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<SelectControl
			className="components-custom-gradient-picker__shape-picker codex-select-large"
			label={ __( 'Shape', 'codex-blocks' ) }
			labelPosition="top"
			onChange={ onShapeChange }
			options={ [
				{ value: 'ellipse', label: __( 'Ellipse', 'codex-blocks'  ) },
				{ value: 'circle', label: __( 'Circle', 'codex-blocks'  ) },
			] }
...
export default function CustomGradientPicker( {
	...
	return (
		<div className={ 'components-base-control components-custom-gradient-picker codex-gradient-control' }>
