<?php
/**
 * codex\Nav_Menus\Component class
 *
 * @package codex
 */

namespace codex\Nav_Menus;

use codex\Component_Interface;
use codex\Templating_Component_Interface;
...
class Nav_Widget_Settings {
	...
	public function add_settings( $widget, $return, $instance ) {
		...
		<p>
			...
			<label for="<?php echo esc_attr( $widget->get_field_id( 'collapse' ) ); ?>"><?php esc_html_e( 'Collapse sub menu items', 'codex' ); ?></label>
		</p>
		<?php
	}
