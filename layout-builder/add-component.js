...
class AddComponent extends Component {
	...
	render() {
		...
		let classForAdd = 'codex-builder-add-item';
		...
		return (
			<div className={ classForAdd } key={ this.props.id }>
				{ this.state.isVisible && (
					<Popover position="top" inline={true} className="codex-popover-add-builder" onClose={ toggleClose }>
						<div className="codex-popover-builder-list">
				...
				<Button
					className="codex-builder-item-add-icon"
					onClick={ () => {
