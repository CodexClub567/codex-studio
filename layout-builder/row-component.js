...
class RowComponent extends Component {
	render() {
		...
		let besideItems = [];
		return (
			<div className={ `codex-builder-areas ${ centerClass }` }>
				<Button
					className="codex-row-left-actions"
					aria-label={ __( 'Edit Settings for', 'codex' ) + ' ' + ( this.props.row === 'popup' ? __( 'Off Canvas', 'codex' ) : this.props.row + ' ' + __( 'Row', 'codex' ) ) }
					onClick={ () => this.props.focusPanel( mode + '_' + this.props.row ) }
					icon="admin-generic"
				>
				</Button>
				<Button
					className="codex-row-actions"
					aria-label={ __( 'Edit Settings for', 'codex' ) + ' ' + ( this.props.row === 'popup' ? __( 'Off Canvas', 'codex' ) : this.props.row + ' ' + __( 'Row', 'codex' ) ) }
					onClick={ () => this.props.focusPanel( mode + '_' + this.props.row ) }
				>
					{ ( this.props.row === 'popup' ? __( 'Off Canvas', 'codex' ) : this.props.row + ' ' + __( 'Row', 'codex' ) ) }
					<Dashicon icon="admin-generic" />
				</Button>
				<div className="codex-builder-group codex-builder-group-horizontal" data-setting={ this.props.row }>
