...
class RadioIconComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			include: {
				logo_only: {
					tooltip: __( 'Logo Only', 'codex' ),
					name: __( 'Logo', 'codex' ),
				},
				logo_title: {
					tooltip: __( 'Logo & Title', 'codex' ),
					name: __( 'Logo & Title', 'codex' ),
				},
				logo_title_tagline: {
					tooltip: __( 'Logo, Title & Tagline', 'codex' ),
					name: __( 'Logo, Title & Tagline', 'codex' ),
				},
			},
			layout: {
				logo_only: {
				...
				logo_title: {
					...
					title_logo: {
						tooltip: __( 'Title - Logo', 'codex' ),
						icon: Icons.titleLogo
					},
					top_logo_title: {
						tooltip: __( 'Top Logo - Title', 'codex' ),
						icon: Icons.topLogoTitle
					},
					top_title_logo: {
						tooltip: __( 'Top Title - Logo', 'codex' ),
				...
				logo_title_tagline: {
					...
					title_tag_logo: {
						tooltip: __( 'Title - Tagline - Logo', 'codex' ),
						icon: Icons.titleTagLogo
					},
					top_logo_title_tag: {
						tooltip: __( 'Top Logo - Title - Tagline', 'codex' ),
						icon: Icons.topLogoTitleTag
					},
					top_title_tag_logo: {
						tooltip: __( 'Top Title - Tagline - Logo', 'codex' ),
						icon: Icons.topTitleTagLogo
					},
					top_title_logo_tag: {
						tooltip: __( 'Top Title - Logo - Tagline', 'codex' ),
	...
	render() {
		...
		return (
			<div className="codex-control-field codex-radio-icon-control">
				<ResponsiveControl
