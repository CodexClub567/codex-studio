...
/**
 * Class codex_Control_Background
 *
 * @access public
 */
class codex_Control_Background extends WP_Customize_Media_Control {
	/**
	 * Control type
	 *
	 * @var string
	 */
	public $type = 'codex_background_control';
...
$wp_customize->register_control_type( 'codex_Control_Background' );
